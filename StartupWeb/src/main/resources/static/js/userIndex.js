...
$(function() {
	...
	stompClient.connect({}, function(frame){
		stompClient.subscribe("/topic/mensajes", function(mensajeJSON){
			...
			document.getElementById("mensajes").innerHTML += "<div id=\"listMensajes\"><a href=\"/StartupWeb/Mensajes/"+mensaje[2]+"\"><div class='message'><p class='text-muted'>"+ mensaje[0] +"</p><span>" + mensaje[1] + "</span></div></a></div>";
		});
	}, function(error){
